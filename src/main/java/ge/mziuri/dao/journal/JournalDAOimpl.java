...
public class JournalDAOimpl implements JournalDAO {
    ...
    @Override
    public void addLabel(Label label, Connection con) throws Exception { try {
    ...
    @Override
    public List<Label> getLabelbyCourseandDate(Course course, Date date, Connection con) throws Exception {
        return null;
    }
}
